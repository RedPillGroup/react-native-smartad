...
const SmartAdRewardedVideoEventEmitter = new NativeEventEmitter(SmartAd);
...
module.exports = {
  ...SmartAd,
  initializeRewardedVideo: () => SmartAd.initializeRewardedVideo(),
  showRewardedVideo: () => SmartAd.showRewardedVideo(),
  addEventListener,
  removeEventListener,
  removeAllListeners
};